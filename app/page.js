...
const onTouchEnd=e=>{
  ...
  if(idx<0)return;
  if(dx<0&&idx<TAB_ORDER.length-1)sView(TAB_ORDER[idx+1]);
  else if(dx>0&&idx>0)sView(TAB_ORDER[idx-1]);
};
...
return<div className="lh-scale" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} style={{minHeight:"100vh",background:bg,paddingBottom:80}}>
...
<BottomNav view={view} setView={sView} unread={unread} c={cfg.primaryColor}/>
</div>;}
